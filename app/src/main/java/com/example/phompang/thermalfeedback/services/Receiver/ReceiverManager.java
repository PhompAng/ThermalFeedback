...
public class ReceiverManager {
	...
	public void responseNotification(long responseTime, int iFeel) {
		this.setThermal_warning(0);
		FirebaseUtils.responseNotification(uid, day, "com.example.phompang.thermalfeedback", responseTime, iFeel);
	}
